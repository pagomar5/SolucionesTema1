...
#Las diferencias que hay son un cambio de peso en los dinosaurios, se puede ver ya que todos tienen un peso distinto
...
#Podemos devir que tienen un comportamineto muy similar y ambos siguen una distribucción Gaussiana
```
