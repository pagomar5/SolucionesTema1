...
diferentes
diferentes2<- setdiff(mammals,Animals2)
diferentes2
#Hay 3 animales y son Dinosaurios
...
#Las diferencias que hay son un cambio de peso en los dinosaurios, se puede ver 
#ya que todos tienen un peso distinto
...
#Podemos decir que tienen un comportamineto muy similar y ambos siguen una distribucción Gaussiana
```
...
#Tengo 229 librerias instaladas
...
dim(cabbages)
#hay 60 registros y 4 variables
str(cabbages)
#La primera variable es un Factor la segunda es un Factor la tercera es 
#numeric y la ultima es in int
#B
summary(is.na(cabbages))
#No hay ningun valor nulo
#c
dim(Chile)
#hay 60 registros y 4 variables
str(Chile)
...
plot(whiteside$Temp, whiteside$Gas, pch=c(6,16)[cabbages$Cult])
legend(x="topright",legend=c("c39","c59"), pch=c(6,16))
